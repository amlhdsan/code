...
% Exam Question Packages (requires the 'exam' class or similar custom environments)
% For this example, we will define custom environments to match your sample.
\usepackage{environ}
\usepackage{xcolor}

\geometry{a4paper, margin=1in}

% --- Custom Environments to match the sample ---

% For multiple choice and fill-in questions
\newcounter{questioncounter}
\NewEnviron{question}{%
    \stepcounter{questioncounter}%
    \par\medskip\noindent\thequestioncounter. \BODY\par\medskip%
}

% For choice items
\def\paren{\leavevmode\unskip\nobreak\quad(\quad\quad)}
\newenvironment{choices}{\begin{list}{}{\setlength{\leftmargin}{2em}\setlength{\labelwidth}{1.5em}}}{\end{list}}
\newcommand{\choice}[1]{\item[A.] #1} % Default \choice marks the correct answer with 'A.'
\renewcommand{\item}[1]{\item[#1]} % To allow custom labels like B., C., D.

% For fill-in-the-blank questions
\newcommand{\fillin}[2][\textwidth]{\underline{\makebox[#1][c]{#2}}}

% For free-response problems
\newcounter{problemcounter}
\setcounter{problemcounter}{14} % Starting the problem counter from 15
\NewEnviron{problem}[1][]{%
    \stepcounter{problemcounter}%
    \par\bigskip\noindent\textbf{\theproblemcounter. (#1)}\par\nopagebreak\small\BODY\par\bigskip%
}


% --- Document Header ---
\title{铜陵一中2025级高一入学信心卷 \\ \vspace{0.5cm} 数学}
\author{}
\date{}
